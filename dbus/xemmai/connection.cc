...
t_scoped t_type_of<t_connection>::f_construct(t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_overload<
...
void t_type_of<t_connection>::f_instantiate(t_object* a_class, t_slot* a_stack, size_t a_n)
{
