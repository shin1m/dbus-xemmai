...
t_type* t_type_of<xemmaix::dbus::t_reply>::f_derive(t_object* a_this)
{
	return nullptr;
}
...
t_scoped t_type_of<xemmaix::dbus::t_reply>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	t_throwable::f_throw(L"uninstantiatable.");
}

void t_type_of<xemmaix::dbus::t_reply>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
